...
class Datakeberatan2016 extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['jalur', 'jenisjaminan', 'kasikeberatan', 'jenispenetapan', 'hasilkeputusan', 'keterangan', 'formalterbit', 'formalaju'], 'string', 'max' => 250],
        ...
        [['mintarisalahtambahan', 'mslh', 'teliti', 'pendpt'], 'string']
        ];
    }
