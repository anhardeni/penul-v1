 ...
 * @property int $seri_brg
 * @property string|null $npwp_imp
 * @property string|null $imp
 * @property string|null $uraian_brg
 * @property string|null $hs_t
 * @property float $trf_bm_t
 * @property float $bm_t_nilai_akhir
 * @property string $hs
 * @property float $trf_bm
 * @property float|null $kurs
 * @property float $bm_nilai_awal
 * @property float $ppn_nilai_awal
 * @property float $ppn_t_nilai_akhir
 * @property float $pph_nilai_awal
 * @property float $pph_t_nilai_akhir
 * @property float $ppnbm_t_nilai_akhir
...
class PenulDatatransaks extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['seri_brg', 'trf_bm_t', 'bm_t_nilai_akhir', 'hs', 'trf_bm', 'bm_nilai_awal', 'ppn_nilai_awal', 'ppn_t_nilai_akhir', 'pph_nilai_awal', 'pph_t_nilai_akhir', 'ppnbm_t_nilai_akhir'], 'required'],
            [['trf_bm_t', 'bm_t_nilai_akhir', 'trf_bm', 'kurs', 'bm_nilai_awal', 'ppn_nilai_awal', 'ppn_t_nilai_akhir', 'pph_nilai_awal', 'pph_t_nilai_akhir', 'ppnbm_t_nilai_akhir', 'nilaipabean_awal', 'nilaipabean_akhir', 'denda', 'total_tagihan'], 'number'],
