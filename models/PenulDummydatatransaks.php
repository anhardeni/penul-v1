...
/**
 * This is the model class for table "penul_dummydatatransaks".
 *
 * @property int $id
 ...
 */
class PenulDummydatatransaks extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'penul_dummydatatransaks';
    }
    ...
    /**
     * {@inheritdoc}
     * @return PenulDummydatatransaksQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new PenulDummydatatransaksQuery(get_called_class());
    }
}
